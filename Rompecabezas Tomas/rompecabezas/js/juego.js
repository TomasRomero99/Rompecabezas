...
function intercambiarPosiciones(fila1, columna1, fila2, columna2){
  var img1=document.getElementById("pieza"+grilla[fila1][columna1]);
  var img2=document.getElementById("pieza"+grilla[fila2][columna2]);
 var padre=img1.parentNode;
var aux=img1.cloneNode(true);
var aux2 = img2.cloneNode(true);
padre.replaceChild(aux2,img1);
padre.replaceChild(aux,img2);
